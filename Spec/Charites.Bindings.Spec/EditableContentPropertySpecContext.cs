...
namespace Charites.Windows.Mvc.Bindings
{
    class EditableContentPropertySpecContext : FixtureSteppable
    {
        ...
        protected EditableDisplayContent<object> DisplayContent { get; } = new EditableDisplayContent<object>();
        protected EditableEditContent<object> EditContent { get; } = new EditableEditContent<object>();
