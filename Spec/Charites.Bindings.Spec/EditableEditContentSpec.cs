...
{
    EditableEditContent<object?> EditContent { get; set; } = new(new object());
    ...
    {
        EditContent.EditCompleted += (_, _) => EditCompletedRaised = true;
        EditContent.EditCanceled += (_, _) => EditCanceledRaised = true;
    }
