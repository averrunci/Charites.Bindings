...
namespace Charites.Windows.Mvc.Bindings
{
    ...
    {
        ObservableProperty<string> PropertyNotAttributedValidation { get; } = new ObservableProperty<string>();

        [Display(Name = "String Expression")]
        [StringLength(10, ErrorMessage = "Please enter {0} within {1} characters.")]
        ObservableProperty<string> PropertyAttributedValidation { get; } = new ObservableProperty<string>();

        [StringLength(6, ErrorMessage = "Please enter within {1} characters.")]
        [RegularExpression("\\d+", ErrorMessage = "Please enter digits only.")]
        ObservableProperty<string> PropertyAttributedMultiValidations { get; } = new ObservableProperty<string>();

        [Required(ErrorMessage = "Please enter a value.")]
        ObservableProperty<string> RequiredProperty { get; } = new ObservableProperty<string>();
        ...
        ObservableProperty<string> LocalizablePropertyAttributedValidation { get; } = new ObservableProperty<string>();
