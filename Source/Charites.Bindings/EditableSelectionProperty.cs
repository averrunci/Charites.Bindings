...
namespace Charites.Windows.Mvc.Bindings
{
    ...
    public static class EditableSelectionPropertyExtensions
    {
        ...
        public static EditableSelectionProperty<T> ToEditableSelectionProperty<T>(this T value, IEnumerable<T> selectionItems) => new EditableSelectionProperty<T>(value, selectionItems);
        ...
        public static EditableSelectionProperty ToEditableSelectionProperty(this string value, IEnumerable<string> selectionItems) => new EditableSelectionProperty(value, selectionItems);
    }
}
