...
namespace Charites.Windows.Mvc.Bindings
{
    ...
    public class EditableContentProperty<T>
    {
        ...
        {
            DisplayContent = displayContent ?? throw new ArgumentNullException(nameof(displayContent));
            EditContent = editContent ?? throw new ArgumentNullException(nameof(editContent));
