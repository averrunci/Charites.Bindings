...
namespace Charites.Windows.Mvc.Bindings
{
    ...
    public class PropertyValueValidateEventArgs<T> : EventArgs
    {
        ...
        {
            if ((result ?? throw new ArgumentNullException(nameof(result))) == ValidationResult.Success) return;
        ...
        {
            this.results.AddRange(results ?? throw new ArgumentNullException(nameof(results)));
        }
    }
}
